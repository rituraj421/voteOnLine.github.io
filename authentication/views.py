    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if cd['password'] == cd['confirm_password']:
                ...
                return render(request, "authentication/registration.html", {'form':form,'note':'password must match'})
    else:
...
def positionView(request):
    ...
    return render(request, "authentication/position.html", {'obj':obj})
...
def candidateView(request, pos):
    ...
    if request.method == "POST":
        ...
        if temp.status == False:
            ...
            return render(request, 'authentication/candidate.html', {'obj':obj})
    else:
        return render(request, 'authentication/candidate.html', {'obj':obj})
...
def resultView(request):
    ...
    return render(request, "authentication/result.html", {'obj':obj})

@login_required
def candidateDetailView(request, id):
    obj = get_object_or_404(Candidate, pk=id)
    return render(request, "authentication/candidate_detail.html", {'obj':obj})
